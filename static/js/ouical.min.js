!(function (e) {
  var o = function (e) {
    ...
    t = function (e) {
      return e.end
        ? o(e.end)
        : o(new Date(e.start.getTime() + 6e4 * e.duration));
    },
    n = {
      google: function (e) {
        var n = o(e.start),
      ...
      yahoo: function (e) {
        var t = e.end
            ? (e.end.getTime() - e.start.getTime()) / 6e4
            : e.duration,
          n =
            (t < 600 ? "0" + Math.floor(t / 60) : Math.floor(t / 60) + "") +
            (t % 60 < 10 ? "0" + (t % 60) : (t % 60) + ""),
    ...
    a = function (e, o, t) {
      ...
      return (
        (n.innerHTML = '<img src="/ai-deadlines/static/img/calendar.png">'),
        Object.keys(e).forEach(function (o) {
          n.innerHTML += '<span class="ind-cal">' + e[o] + "</span>";
        }),
        (n.className = "add-to-calendar"),
        void 0 !== o && (n.className += " " + o),
  ...
  e.createCalendar = function (e) {
    ...
    if (
      void 0 !== (o = e).data &&
      void 0 !== o.data.start &&
      (void 0 !== o.data.end || void 0 !== o.data.duration)
    )
      return a(
        ((i = e.data),
        {
